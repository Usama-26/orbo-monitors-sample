  ...
  return (
    <AppLayout>
      <section className="bg-gradient-to-r from-indigo-500/80 from-10% via-secondary via-50% to-purple-900 to-90% h-44">
        <div className="pl-12 pr-8 py-5 flex justify-between">
      ...
      <section>
        <div className="pl-12 pr-8 flex justify-end -translate-y-3/4">
        ...
        <div className="pl-12 pr-8">
          <div>
            <div className="flex items-center">
              <h4 className="text-zinc-100 font-semibold text-xl">Monitors</h4>
          ...
          <div className="flex my-4 gap-4">
            ...
            <div className="basis-72 rounded-lg bg-[#130C21] p-6">
